...
const config = {
  ...
  "inlineSchemaHash": "24019b3a0e0767d891d0a371a582a9e4acb0433e3df07db83ebb51fd7426b605",
  "copyEngine": true
}
...
if (!fs.existsSync(path.join(__dirname, 'schema.prisma'))) {
  const alternativePaths = [
    "src/lib/generated/client2",
    "lib/generated/client2",
  ]
...
path.join(process.cwd(), "src/lib/generated/client2/query_engine-windows.dll.node")

// file annotations for bundling tools to include these files
path.join(__dirname, "libquery_engine-rhel-openssl-3.0.x.so.node");
path.join(process.cwd(), "src/lib/generated/client2/libquery_engine-rhel-openssl-3.0.x.so.node")
// file annotations for bundling tools to include these files
path.join(__dirname, "schema.prisma");
path.join(process.cwd(), "src/lib/generated/client2/schema.prisma")
